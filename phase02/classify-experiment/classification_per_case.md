...
- Setup: fixture=basic-ci, secrets=[]
...
- 维度: completeness | 优先级: P1
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=container-ci, secrets=['REGISTRY_USERNAME', 'REGISTRY_PASSWORD']
- 断言: 4/4 可映射, 0 无法映射, 0 需 LLM
- 阻断项:
  - 未知 repo_fixture 'container-ci'，需确认测试仓前置资源
  ✅ assert[0] type=positive target=run_logs eval=deterministic
     → kind: `value`
...
- 维度: completeness | 优先级: P1
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=matrix-ci, secrets=[]
- 断言: 4/4 可映射, 0 无法映射, 0 需 LLM
- 阻断项:
  - 未知 repo_fixture 'matrix-ci'，需确认测试仓前置资源
  ✅ assert[0] type=positive target=run_logs eval=deterministic
     → kind: `value`
...
- 维度: compatibility | 优先级: P1
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=basic-ci, secrets=['TEST_TOKEN']
- 断言: 4/4 可映射, 0 无法映射, 0 需 LLM
  ✅ assert[0] type=positive target=run_logs eval=deterministic
     → kind: `value`
     ⚠️ 缺: 无法从 rubric 提取具体 expect 值
...
- 维度: compatibility | 优先级: P1
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=matrix-compat, secrets=[]
- 断言: 6/6 可映射, 0 无法映射, 0 需 LLM
- 阻断项:
  - 未知 repo_fixture 'matrix-compat'，需确认测试仓前置资源
  ✅ assert[0] type=positive target=run_logs eval=deterministic
     → kind: `value`
...
- Setup: fixture=with-secrets, secrets=['API_TOKEN']
- 断言: 4/4 可映射, 0 无法映射, 0 需 LLM
- 阻断项:
...
- 维度: compatibility | 优先级: P1
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=basic-ci, secrets=['TRIGGER_TOKEN']
- 断言: 2/2 可映射, 0 无法映射, 0 需 LLM
  ✅ assert[0] type=negative target=run_status eval=deterministic
     → kind: `status`
  ✅ assert[1] type=positive target=run_logs eval=deterministic
...
- 维度: compatibility | 优先级: P1
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=with-secrets, secrets=['TEST_SECRET']
- 断言: 4/4 可映射, 0 无法映射, 0 需 LLM
...
- 维度: compatibility | 优先级: P1
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=basic-ci, secrets=['CALLEE_SECRET']
- 断言: 2/2 可映射, 0 无法映射, 0 需 LLM
  ✅ assert[0] type=positive target=run_logs eval=deterministic
     → kind: `value`
     ⚠️ 缺: 无法从 rubric 提取具体 expect 值
...
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=large-repo, secrets=[]
...
- 维度: reliability | 优先级: P1
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=preemption-ci, secrets=[]
- 断言: 4/4 可映射, 0 无法映射, 0 需 LLM
- 阻断项:
  - 未知 repo_fixture 'preemption-ci'，需确认测试仓前置资源
  ✅ assert[0] type=positive target=run_status eval=deterministic
     → kind: `status`
  ✅ assert[1] type=negative target=run_status eval=deterministic
     → kind: `status`
...
- 维度: security | 优先级: P1
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=private-registry, secrets=['REGISTRY_USERNAME', 'REGISTRY_PASSWORD']
- 断言: 4/4 可映射, 0 无法映射, 0 需 LLM
  ✅ assert[0] type=positive target=run_logs eval=deterministic
     → kind: `value`
...
- 维度: security | 优先级: P1
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=container-isolation, secrets=['HOST_SECRET_MARKER']
- 断言: 4/4 可映射, 0 无法映射, 0 需 LLM
- 阻断项:
  - 未知 repo_fixture 'container-isolation'，需确认测试仓前置资源
  ✅ assert[0] type=positive target=run_logs eval=deterministic
     → kind: `value`
     → 候选值: ['EXPLICIT_VAR_OK']
  ✅ assert[1] type=negative target=run_logs eval=deterministic
...
- 维度: security | 优先级: P1
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=with-secrets, secrets=['DISK_TEST_SECRET']
- 断言: 2/2 可映射, 0 无法映射, 0 需 LLM
  ✅ assert[0] type=positive target=run_logs eval=deterministic
     → kind: `value`
     → 候选值: ['DISK_NO_LEAK']
...
- 维度: security | 优先级: P1
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=with-secrets, secrets=['ENV_SECRET']
- 断言: 2/2 可映射, 0 无法映射, 0 需 LLM
  ✅ assert[0] type=positive target=run_status eval=deterministic
     → kind: `status`
  ✅ assert[1] type=negative target=run_logs eval=
...
- 维度: security | 优先级: P1
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=environment-protected, secrets=['DEPLOY_TOKEN']
- 断言: 4/4 可映射, 0 无法映射, 0 需 LLM
  ✅ assert[0] type=positive target=run_logs eval=deterministic
     → kind: `value`
...
- Setup: fixture=with-secrets, secrets=['DEPLOY_TOKEN']
- 断言: 5/5 可映射, 0 无法映射, 0 需 LLM
- 阻断项:
...
- 维度: security | 优先级: P0
- Trigger: event=fork_pr, as=untrusted_contributor, supported=False
- Setup: fixture=with-secrets, secrets=['DEPLOY_KEY', 'ORG_TOKEN']
- 断言: 5/5 可映射, 0 无法映射, 0 需 LLM
- 阻断项:
  - fork_pr：需第二 GitCode 账号/token 模拟 untrusted 外部贡献者
  - trigger.as=untrusted_contributor：需第二 GitCode 账号/token 模拟外部贡献者
...
- 维度: security | 优先级: P0
- Trigger: event=fork_pr, as=untrusted_contributor, supported=False
- Setup: fixture=with-target-workflow, secrets=[]
- 断言: 3/3 可映射, 0 无法映射, 0 需 LLM
- 阻断项:
  - fork_pr：需第二 GitCode 账号/token 模拟 untrusted 外部贡献者
  - trigger.as=untrusted_contributor：需第二 GitCode 账号/token 模拟外部贡献者
  - 未知 repo_fixture 'with-target-workflow'，需确认测试仓前置资源
  ✅ assert[0] type=positive target=run_logs eval=deterministic
     → kind: `value`
...
- 维度: security | 优先级: P0
- Trigger: event=fork_pr, as=untrusted_contributor, supported=False
- Setup: fixture=with-secrets, secrets=[]
- 断言: 3/3 可映射, 0 无法映射, 0 需 LLM
- 阻断项:
  - fork_pr：需第二 GitCode 账号/token 模拟 untrusted 外部贡献者
  - trigger.as=untrusted_contributor：需第二 GitCode 账号/token 模拟外部贡献者
...
- 维度: security | 优先级: P0
- Trigger: event=fork_pr, as=untrusted_contributor, supported=False
- Setup: fixture=with-pr-trigger, secrets=[]
- 断言: 3/3 可映射, 0 无法映射, 0 需 LLM
- 阻断项:
  - fork_pr：需第二 GitCode 账号/token 模拟 untrusted 外部贡献者
  - trigger.as=untrusted_contributor：需第二 GitCode 账号/token 模拟外部贡献者
  - 未知 repo_fixture 'with-pr-trigger'，需确认测试仓前置资源
  ✅ assert[0] type=positive target=run_logs eval=deterministic
     → kind: `value`
...
- 维度: security | 优先级: P0
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=with-permissions, secrets=[]
- 断言: 2/2 可映射, 0 无法映射, 0 需 LLM
- 阻断项:
  - 未知 repo_fixture 'with-permissions'，需确认测试仓前置资源
  ✅ assert[0] type=positive target=run_logs eval=deterministic
     → kind: `value`
     → 候选值: ['PUSH_REJECTED_AS_EXPECTED']
  ✅ assert[1] type=negative target=run_logs eval=deterministic
...
- 维度: security | 优先级: P1
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=branch-protected, secrets=[]
- 断言: 3/3 可映射, 0 无法映射, 0 需 LLM
- 阻断项:
  - 未知 repo_fixture 'branch-protected'，需确认测试仓前置资源
  ✅ assert[0] type=positive target=run_logs eval=deterministic
     → kind: `value`
...
- 维度: security | 优先级: P0
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=with-secrets, secrets=['LEAK_TEST_SECRET']
- 断言: 3/3 可映射, 0 无法映射, 0 需 LLM
  ✅ assert[0] type=positive target=run_logs eval=deterministic
     → kind: `value`
...
- 维度: security | 优先级: P0
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=with-secrets, secrets=['SECRET_A']
- 断言: 2/2 可映射, 0 无法映射, 0 需 LLM
  ✅ assert[0] type=positive target=run_logs eval=deterministic
     → kind: `value`
     → 候选值: ['SECRET_EMPTY_AS_EXPECTED']
...
- 维度: security | 优先级: P0
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=with-secrets, secrets=['SPLIT_SECRET']
- 断言: 1/2 可映射, 1 无法映射, 1 需 LLM
- 阻断项:
  - eval=llm_assisted, 需要 LLM 判定
  ✅ assert[0] type=negative target=run_logs eval=
...
- 维度: security | 优先级: P1
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=with-secrets, secrets=['MULTILINE_SECRET']
- 断言: 1/2 可映射, 1 无法映射, 1 需 LLM
- 阻断项:
  - eval=llm_assisted, 需要 LLM 判定
  ✅ assert[0] type=negative target=run_logs eval=
...
- 维度: security | 优先级: P1
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=with-secrets, secrets=['COMPOUND_SECRET']
- 断言: 3/3 可映射, 0 无法映射, 0 需 LLM
  ✅ assert[0] type=negative target=run_logs eval=
     → kind: `mask`
...
- 维度: security | 优先级: P1
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=with-secrets, secrets=['SIDECHAN_SECRET']
...
- 维度: security | 优先级: P1
- Trigger: event=push, as=maintainer, supported=True
- Setup: fixture=basic-ci, secrets=['TOKEN_TEST_SECRET']
- 断言: 2/2 可映射, 0 无法映射, 0 需 LLM
  ✅ assert[0] type=positive target=run_logs eval=deterministic
     → kind: `value`
     ⚠️ 缺: 无法从 rubric 提取具体 expect 值
