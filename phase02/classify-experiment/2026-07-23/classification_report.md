# Case 可脚本化分类报告 — 2026-07-23 VALID (229 cases)

**数据源**: `phase02/classify-experiment/2026-07-23/VALID/` (仅含平台校验通过的 229 cases)
...
| 分类 | 数量 | 占比 | 含义 |
|------|------|------|------|
| `full_scriptable` | **128** | 55.9% | trigger 可触发 + 全部断言可映射 + 无 setup/fault 阻断 |
| `partial_scriptable` | **69** | 30.1% | trigger 可触发但存在部分阻断 |
| `not_scriptable` | **32** | 14.0% | trigger 不可触发或有不可自动化阻断 |

## 按维度 × 分类

| 维度 | full | partial | not | 合计 |
|------|------|---------|-----|------|
| completeness | 18 | 12 | 10 | 40 |
| compatibility | 39 | 7 | 5 | 51 |
| reliability | 27 | 38 | 0 | 65 |
| security | 20 | 7 | 15 | 42 |
| usability | 24 | 5 | 2 | 31 |
| **合计** | **128** | **69** | **32** | **229** |
...
| 阻断 | Cases |
|------|-------|
| trigger.as=untrusted_contributor: needs second account token | 20 |
| trigger pull_request: needs PR/fork API + second account | 15 |
| trigger pull_request_target: needs PR/fork API + second account | 9 |
| trigger schedule: platform limitation | 3 |
| trigger issue_comment: unknown/unmapped trigger event | 3 |
| trigger pr: unknown/unmapped trigger event | 1 |
| trigger fork_pr: needs PR/fork API + second account | 1 |
...
### 断言层 — LLM 辅助判定
- 38 cases 包含 `eval=llm_assisted` 断言
...
### ✓ COMP-ARTIFACT-01-001 — full_scriptable
...
### ✓ COMP-ARTIFACT-01-002 — full_scriptable
- 维度: completeness | 优先级: P1
- 标题: 下载全部制品功能正常
- Trigger: OK
...
### ✓ COMP-CACHE-01-001 — full_scriptable
...
### ✓ COMP-DIR-01-001 — full_scriptable
- 维度: completeness | 优先级: P1
...
### ✓ COMP-ISOLATION-01-001 — full_scriptable
- 维度: completeness | 优先级: P0
...
### ✓ COMP-ISOLATION-01-002 — full_scriptable
- 维度: completeness | 优先级: P0
- 标题: 环境变量不跨 job 泄漏
- Trigger: OK
- 断言: 2 total / 2 mappable / 0 LLM / 0 unmappable
...
### ✓ COMP-PERMS-01-001 — full_scriptable
- 维度: completeness | 优先级: P0
...
### ✓ COMP-PERMS-01-002 — full_scriptable
- 维度: completeness | 优先级: P0
...
### ✓ COMP-PUSH-01-001 — full_scriptable
- 维度: completeness | 优先级: P1
...
### ✓ COMP-RUNNER-01-001 — full_scriptable
- 维度: completeness | 优先级: P1
...
### ✓ COMP-RUNNER-01-002 — full_scriptable
- 维度: completeness | 优先级: P1
...
### ✓ COMP-SECRET-01-001 — full_scriptable
- 维度: completeness | 优先级: P0
...
### ✓ COMP-SECRET-01-002 — full_scriptable
- 维度: completeness | 优先级: P0
...
### ✓ COMP-STATUS-01-001 — full_scriptable
- 维度: completeness | 优先级: P1
...
### ✓ COMP-STATUS-01-002 — full_scriptable
- 维度: completeness | 优先级: P1
...
### ✓ COMP-TIMEOUT-01-001 — full_scriptable
- 维度: completeness | 优先级: P1
...
### ✓ COMP-TIMEOUT-01-002 — full_scriptable
- 维度: completeness | 优先级: P1
...
### ✓ COMP-UNKNOWN-01-002 — full_scriptable
- 维度: completeness | 优先级: P1
...
### ✓ COMPAT-ACTION-01-001 — full_scriptable
...
### ✓ COMPAT-ACTION-01-002 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-ARTIFACT-01-001 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-ARTIFACT-01-002 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-CACHE-01-001 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-CTX-01-002 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-DIR-01-001 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-ENV-01-001 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-EXPR-01-001 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-EXPR-01-002 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-EXPR-01-003 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-EXPR-01-004 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-EXPR-01-005 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-EXPR-01-006 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-EXPR-01-007 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-EXPR-01-008 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-EXPR-01-009 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-EXPR-01-010 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-EXPR-01-011 — full_scriptable
- 维度: compatibility | 优先级: P1
- 标题: join() 函数缺失时的降级行为
- Trigger: OK
- 断言: 2 total / 1 mappable / 1 LLM / 1 unmappable
...
### ✓ COMPAT-EXPR-01-012 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-IF-01-001 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-IF-01-002 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-INPUTS-01-001 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-INPUTS-01-002 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-ISOLATE-01-001 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-ISOLATE-01-002 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-MASK-01-001 — full_scriptable
...
### ✓ COMPAT-MASK-01-002 — full_scriptable
- 维度: compatibility | 优先级: P0
...
### ✓ COMPAT-OUTCOME-01-001 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-OUTCOME-01-002 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-PERM-01-001 — full_scriptable
- 维度: compatibility | 优先级: P0
...
### ✓ COMPAT-PERM-01-004 — full_scriptable
- 维度: compatibility | 优先级: P0
...
### ✓ COMPAT-RUNNER-01-001 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-RUNNER-01-002 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-RUNSON-01-001 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-RUNSON-01-002 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-SHELL-01-001 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-SHELL-01-002 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ COMPAT-VARS-01-001 — full_scriptable
- 维度: compatibility | 优先级: P1
...
### ✓ REL-CANCEL-01-028 — full_scriptable
...
### ✓ REL-CONC-01-001 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-CONC-01-002 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-CPU-01-022 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-DISK-01-018 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-DISK-01-019 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-FLOOD-01-036 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-IGNORE-01-004 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-IMAGE-01-052 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-IMAGE-01-052-V2 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-LONG-01-043 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-MATRIX-01-026 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-MATRIX-01-027 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-MATRIX-01-038 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-MEM-01-020 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-MEM-01-021 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-NEST-01-023 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-NEST-01-024 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-PATHS-01-014 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-PATHS-01-015 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-QUEUE-01-003 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-RERUN-01-011 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-TIMEOUT-01-007 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-TIMEOUT-01-008 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-TIMEOUT-01-009 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-TIMEOUT-01-010 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ REL-YAMLCACHE-01-060 — full_scriptable
- 维度: reliability | 优先级: P1
...
### ✓ SEC-DEFPERM-01-001 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ SEC-DOS-01-001 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ SEC-INJ-01-005 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ SEC-MASK-01-001 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ SEC-MASK-01-003 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ SEC-MASK-01-004 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ SEC-MASK-01-005 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ SEC-MASK-01-006 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ SEC-NAME-01-001 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ SEC-NET-01-001 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ SEC-PERM-01-003 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ SEC-PERM-01-004 — full_scriptable
- 维度: security | 优先级: P0
- 标题: 默认状态下写操作被 403 拒绝
- Trigger: OK
- 断言: 2 total / 2 mappable / 0 LLM / 0 unmappable
...
### ✓ SEC-RUN-01-001 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ SEC-RUN-01-002 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ SEC-SIDE-01-001 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ SEC-SIDE-01-002 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ SEC-SUPPLY-01-001 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ SEC-SUPPLY-01-002 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ SEC-TOCTOU-01-001 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ SEC-WCMD-01-001 — full_scriptable
- 维度: security | 优先级: P0
...
### ✓ USE-ACT-01-001 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-ACT-01-002 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-ANNOT-01-001 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-BADGE-01-001 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-CONC-01-001 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-CTX-01-001 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-CTX-01-002 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-DEPR-01-001 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-DEPR-01-002 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-DIR-01-001 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-DISP-01-001 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-DISP-01-002 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-ENV-01-001 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-EXPR-01-001 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-INPT-01-001 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-INPT-01-002 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-LOG-01-001 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-PERM-01-001 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-RUN-01-001 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-SEARCH-01-001 — full_scriptable
- 维度: usability | 优先级: P1
- 标题: 日志搜索与下载功能可用且交互流畅
- Trigger: OK
- 断言: 2 total / 1 mappable / 1 LLM / 1 unmappable
...
### ✓ USE-SECNAME-01-001 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-SECNAME-01-002 — full_scriptable
- 维度: usability | 优先级: P1
...
### ✓ USE-STAT-01-001 — full_scriptable
- 维度: usability | 优先级: P1
...
### ◐ COMP-ARTIFACT-01-003 — partial_scriptable
- 维度: completeness | 优先级: P1
- 标题: artifact 保留期设置生效
- Trigger: OK
...
### ◐ COMP-CACHE-01-002 — partial_scriptable
- 维度: completeness | 优先级: P0
...
### ◐ COMP-CALL-01-001 — partial_scriptable
- 维度: completeness | 优先级: P1
...
### ◐ COMP-CALL-01-002 — partial_scriptable
- 维度: completeness | 优先级: P1
...
### ◐ COMP-PUSH-01-002 — partial_scriptable
- 维度: completeness | 优先级: P1
...
### ◐ COMP-PUSH-01-003 — partial_scriptable
- 维度: completeness | 优先级: P1
...
### ◐ COMP-RERUN-01-001 — partial_scriptable
- 维度: completeness | 优先级: P1
...
### ◐ COMP-RERUN-01-002 — partial_scriptable
- 维度: completeness | 优先级: P1
...
### ◐ COMP-RERUN-01-003 — partial_scriptable
- 维度: completeness | 优先级: P1
...
### ◐ COMP-SECRET-01-003 — partial_scriptable
- 维度: completeness | 优先级: P0
...
### ◐ COMP-SUMMARY-01-001 — partial_scriptable
- 维度: completeness | 优先级: P1
...
### ◐ COMP-SUMMARY-01-002 — partial_scriptable
- 维度: completeness | 优先级: P1
...
### ◐ COMPAT-CTX-01-001 — partial_scriptable
- 维度: compatibility | 优先级: P1
...
### ◐ COMPAT-DIR-01-002 — partial_scriptable
- 维度: compatibility | 优先级: P1
...
### ◐ COMPAT-ENV-01-002 — partial_scriptable
- 维度: compatibility | 优先级: P1
...
### ◐ COMPAT-NEST-01-001 — partial_scriptable
- 维度: compatibility | 优先级: P1
...
### ◐ COMPAT-NEST-01-002 — partial_scriptable
- 维度: compatibility | 优先级: P1
...
### ◐ COMPAT-OUTCOME-01-003 — partial_scriptable
- 维度: compatibility | 优先级: P1
...
### ◐ COMPAT-VARS-01-002 — partial_scriptable
- 维度: compatibility | 优先级: P1
...
### ◐ REL-API-01-065 — partial_scriptable
...
### ◐ REL-ART-01-041 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-ARTCONC-01-063 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-ARTPERF-01-053 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-ARTPERF-01-053-V2 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-BIGRUNNER-01-066 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-CACHE-01-046 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-CACHEPERF-01-054 — partial_scriptable
- 维度: reliability | 优先级: P2
...
### ◐ REL-CANCELREL-01-061 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-CHILDSTATE-01-064 — partial_scriptable
...
### ◐ REL-CHILDSTATE-01-064-V2 — partial_scriptable
- 维度: reliability | 优先级: P0
...
### ◐ REL-CONTINUE-01-030 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-FAIR-01-044 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-FAULT-01-031 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-FAULT-01-032 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-FAULT-01-033 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-FAULT-01-034 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-FAULT-01-035 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-FLOOD-01-037 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-K8S-01-045 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-LATENCY-01-050 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-LATENCY-01-050-V2 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-LOGPERF-01-051 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-LOGPERF-01-051-V2 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-LOGSTABLE-01-059 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-MATRIX-01-039 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-MATRIXFAIR-01-056 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-NEEDS-01-025 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-NETFAULT-01-062 — partial_scriptable
- 维度: reliability | 优先级: P2
...
### ◐ REL-OUTPUT-01-016 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-PRESSURE-01-055 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-RERUN-01-012 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-RERUN-01-013 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-RETAIN-01-047 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-RUNNER-01-049 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-RUNNER-01-049-V2 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-SCHED-01-057 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ REL-STATE-01-058 — partial_scriptable
- 维度: reliability | 优先级: P1
...
### ◐ SEC-ARTF-01-002 — partial_scriptable
- 维度: security | 优先级: P0
...
### ◐ SEC-CACHE-01-002 — partial_scriptable
- 维度: security | 优先级: P0
...
### ◐ SEC-INJ-01-004 — partial_scriptable
- 维度: security | 优先级: P0
...
### ◐ SEC-MASK-01-002 — partial_scriptable
- 维度: security | 优先级: P0
...
### ◐ SEC-OIDC-01-001 — partial_scriptable
- 维度: security | 优先级: P1
...
### ◐ SEC-RUN-01-003 — partial_scriptable
- 维度: security | 优先级: P0
...
### ◐ SEC-WCMD-01-002 — partial_scriptable
- 维度: security | 优先级: P0
...
### ◐ USE-ENV-01-002 — partial_scriptable
- 维度: usability | 优先级: P1
...
### ◐ USE-LBL-01-002 — partial_scriptable
- 维度: usability | 优先级: P1
...
### ◐ USE-MASK-01-002 — partial_scriptable
- 维度: usability | 优先级: P0
...
### ◐ USE-MD-01-001 — partial_scriptable
- 维度: usability | 优先级: P1
...
### ◐ USE-UNKN-01-002 — partial_scriptable
- 维度: usability | 优先级: P1
...
### ✗ COMP-CACHE-01-003 — not_scriptable
- 维度: completeness | 优先级: P0
- 标题: fork PR 不应覆盖或污染主分支 cache
- Trigger: BLOCKED
- 断言: 2 total / 0 mappable / 0 LLM / 2 unmappable
- 阻断项:
  - trigger pull_request: needs PR/fork API + second account
  - trigger.as=untrusted_contributor: needs second account token
  - unknown repo_fixture 'with-cache'
...
### ✗ COMP-PERMS-01-003 — not_scriptable
- 维度: completeness | 优先级: P0
...
### ✗ COMP-PR-01-002 — not_scriptable
- 维度: completeness | 优先级: P0
- 标题: pull_request_target 可访问 secrets 且 TOKEN 拥有写权限
- Trigger: BLOCKED
- 断言: 2 total / 2 mappable / 0 LLM / 0 unmappable
- 阻断项:
  - trigger pull_request_target: needs PR/fork API + second account
  ✅ [0] type=positive target=run_logs eval=deterministic → run_logs (implicit value)
  ✅ [1] type=positive target=run_status eval=deterministic → equals='success'

### ✗ COMP-PR-01-003 — not_scriptable
- 维度: completeness | 优先级: P0
...
### ✗ COMP-PRTARGET-01-001 — not_scriptable
- 维度: completeness | 优先级: P0
...
### ✗ COMP-PRTARGET-01-002 — not_scriptable
- 维度: completeness | 优先级: P0
...
### ✗ COMP-SCHEDULE-01-001 — not_scriptable
- 维度: completeness | 优先级: P1
- 标题: 合法 cron 在默认分支按时触发
- Trigger: BLOCKED
- 断言: 2 total / 1 mappable / 0 LLM / 1 unmappable
- 阻断项:
  - trigger schedule: platform limitation
  ✅ [0] type=positive target=run_status eval=deterministic → equals='success'
  ⬜ [1] type=positive target=run_event eval=deterministic → needs run detail assertion kind

### ✗ COMP-SCHEDULE-01-002 — not_scriptable
- 维度: completeness | 优先级: P1
...
- 阻断项:
  - trigger schedule: platform limitation
  - unknown repo_fixture 'multi-branch'
  ⬜ [0] type=negative target=run_created eval=deterministic → needs run detail assertion kind

### ✗ COMP-SCHEDULE-01-003 — not_scriptable
- 维度: completeness | 优先级: P1
...
- 阻断项:
  - trigger schedule: platform limitation
  ✅ [0] type=negative target=run_status eval=deterministic → equals='success_with_1min_interval'
  🤖 [1] type=nonfunctional target=error_message eval=llm_assisted → LLM辅助

### ✗ COMPAT-CACHE-01-002 — not_scriptable
- 维度: compatibility | 优先级: P0
...
### ✗ COMPAT-PERM-01-002 — not_scriptable
- 维度: compatibility | 优先级: P0
- 标题: 未声明 permissions 时 fork PR 写操作隔离
- Trigger: BLOCKED
- 断言: 2 total / 2 mappable / 0 LLM / 0 unmappable
- 阻断项:
  - trigger fork_pr: needs PR/fork API + second account
  - trigger.as=untrusted_contributor: needs second account token
  ✅ [0] type=negative target=run_status eval=deterministic → equals='success'
  ✅ [1] type=negative target=run_logs eval=deterministic → run_logs (implicit value)

### ✗ COMPAT-PR-01-001 — not_scriptable
- 维度: compatibility | 优先级: P0
...
### ✗ COMPAT-TARGET-01-001 — not_scriptable
- 维度: compatibility | 优先级: P0
...
### ✗ COMPAT-TARGET-01-002 — not_scriptable
- 维度: compatibility | 优先级: P0
...
### ✗ SEC-ARTF-01-001 — not_scriptable
- 维度: security | 优先级: P0
...
### ✗ SEC-BASE-01-001 — not_scriptable
- 维度: security | 优先级: P0
...
### ✗ SEC-BASE-01-002 — not_scriptable
- 维度: security | 优先级: P0
...
### ✗ SEC-CACHE-01-001 — not_scriptable
- 维度: security | 优先级: P0
...
### ✗ SEC-COMM-01-001 — not_scriptable
- 维度: security | 优先级: P0
- 标题: issue_comment / pull_request_comment 触发关键字过滤必须不可被绕过
- Trigger: BLOCKED
- 断言: 2 total / 2 mappable / 0 LLM / 0 unmappable
- 阻断项:
  - trigger issue_comment: unknown/unmapped trigger event
  - trigger.as=untrusted_contributor: needs second account token
  ✅ [0] type=negative target=run_status eval=deterministic → status check
  ✅ [1] type=positive target=run_logs eval=deterministic → run_logs (implicit value)

### ✗ SEC-FORK-01-001 — not_scriptable
- 维度: security | 优先级: P0
- 标题: fork PR 触发 pull_request 时不可读取项目 secrets
- Trigger: BLOCKED
- 断言: 2 total / 2 mappable / 0 LLM / 0 unmappable
...
### ✗ SEC-FORK-01-002 — not_scriptable
- 维度: security | 优先级: P0
...
### ✗ SEC-PRTGT-01-001 — not_scriptable
- 维度: security | 优先级: P0
...
### ✗ SEC-PRTGT-01-002 — not_scriptable
- 维度: security | 优先级: P0
...
### ✗ SEC-TOCTOU-01-002 — not_scriptable
- 维度: security | 优先级: P0
...
### ✗ SEC-TOKEN-01-001 — not_scriptable
- 维度: security | 优先级: P0
...
### ✗ SEC-TOKEN-01-002 — not_scriptable
- 维度: security | 优先级: P0
...
### ✗ USE-ANNOT-01-002 — not_scriptable
- 维度: usability | 优先级: P1
...
### ✗ USE-TYPE-01-001 — not_scriptable
- 维度: usability | 优先级: P1
